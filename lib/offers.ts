export type BaseOfferId = "box-1" | "box-2" | "box-3";
export type OfferId = BaseOfferId | "box-1-upsell" | "box-2-upsell";
...
export const OFFERS: Record<BaseOfferId, Offer> = {
...
export function toBaseOfferId(id: OfferId): BaseOfferId {
  return (["box-1", "box-2", "box-3"].includes(id) ? id : "box-1") as BaseOfferId;
}

export function savingsFor(id: OfferId): number {
  const o = OFFERS[toBaseOfferId(id)];
