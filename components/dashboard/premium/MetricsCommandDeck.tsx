  ...
  const tiles: Tile[] = [
    {
      ...
      hint: kpis.totalOrders.toLocaleString("en-US") + " orders, converted at 3.75 SAR/USD",
      icon: Banknote,
    ...
    },
    {
      ...
      value: kpis.totalOrders === 0 ? "—" : formatUsd(a.avgOrderValue),
      hint: kpis.totalOrders === 0 ? "Need at least one order" : "Revenue divided by order count",
      icon: TrendingUp,
    ...
    },
    {
      ...
      value: kpis.deliveredCount === 0 ? "—" : formatUsd(deliveredRevenue),
      hint: "USD from rows flagged delivered",
      icon: Receipt,
