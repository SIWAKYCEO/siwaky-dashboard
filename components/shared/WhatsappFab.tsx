...
export default function WhatsappFab() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed left-4 bottom-24 z-30 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg md:bottom-6 md:left-6"
    >
